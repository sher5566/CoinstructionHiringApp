...
export default function SearchForWorkforce() {
  ...
  const handleChange = (e) => {
    ...
    if (e.target.id === "profession") {
      setSideBarData({ ...sideBarData, profession: e.target.value });
    }
  ...
  const handleSubmit = (e) => {
    ...
    urlParams.set("profession", sideBarData.profession);
      ...
      <div className="flex-1">
        <h1 className="text-3xl font-semibold border-b p-3 text-slate-700 mt-5">
          List of{" "}
            ...
            {!loading && listings && listings[0] && listings[0].profession}'s
        ...
        <div className="p-7 flex flex-wrap gap-4">
          ...
          {!loading &&
            ...
            listings.map((listing) => (
              <WorkforceListingItem key={listing._id} listing={listing} />
            ))}
          {showMore && (
            <button
